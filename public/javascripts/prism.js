/* PrismJS 1.15.0
 https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+c+csharp+cpp+aspnet+markup-templating+git+php+sql+regex&plugins=line-numbers+toolbar+show-language */
var _self = 'undefined' != typeof window
    ...
    Prism = function ( g ) {
          ...
          C = {
              ...
              clone:  function t ( e, n ) {
                ...
                switch ( n = n || {}, i ) {
                  case'Object':
                    ...
                    return r;
                  case'Array':
                    return a = C.util.objId(e), n[ a ]
                                                ? n[ a ]
                                                : (r = [], n[ a ] = r, e.forEach(function ( e, a ) {r[ a ] = t(e, n);}), r);
                  default:
                    return e;
                }
              }
            ...
            languages: {
              ...
              insertBefore: function ( t, e, a, n ) {
                ...
                var s = n[ t ];
                return n[ t ] = i, C.languages.DFS(C.languages, function ( e, a ) {a === s && e != t && (this[ e ] = i);}), i;
              },
            ...
            plugins: {},
            highlightAll: function ( e, a ) {C.highlightAllUnder(document, e, a);},
            ...
            highlightElement: function ( e, a, t ) {
              ...
              i && (n = (i.className.match(c) || [
                , ''
              ])[ 1 ].toLowerCase(), r = C.languages[ n ]), e.className = e.className.replace(c, '')
                                                                           .replace(/\s+/g, ' ') + ' language-' + n, e.parentNode && (i = e.parentNode, /pre/i.test(i.nodeName) && (i.className = i.className.replace(c, '')
              ...
              var l = {
                  ...
                  o = function ( e ) {l.highlightedCode = e, C.hooks.run('before-insert', l), l.element.innerHTML = l.highlightedCode, C.hooks.run('after-highlight', l), C.hooks.run('complete', l), t && t.call(l.element);};
              if (C.hooks.run('before-sanity-check', l), l.code) if (C.hooks.run('before-highlight', l), l.grammar) if (a && g.Worker) {
                var s = new Worker(C.filename);
                s.onmessage = function ( e ) {o(e.data);}, s.postMessage(JSON.stringify({
                  language:       l.language,
                  code:           l.code,
                  immediateClose: !0
                }));
                  ...
                  for ( var y = n, v = r; y < a.length; v += a[ y ].length, ++y ) {
                    ...
                    if (!(k instanceof M)) {
                      if (f && y != a.length - 1) {
                        ...
                        for ( var b = x.index + (h
                                                 ? x[ 1 ].length
                                                 : 0), w = x.index + x[ 0 ].length, A = y, P = v, O = a.length; A < O && (P < w || !a[ A ].type && !a[ A - 1 ].greedy); ++A ) (P += a[ A ].length) <= b && (++y, v = P);
      ...
      function M ( e, a, t, n, r ) {this.type = e, this.content = a, this.alias = t, this.length = 0 | (n || '').length, this.greedy = !!r;}

      if (g.Prism = C, M.stringify = function ( a, t, e ) {
        if ('string' == typeof a) return a;
        if (Array.isArray(a)) return a.map(function ( e ) {return M.stringify(e, t, a);})
                                      .join('');
        var n = {
          type: a.type,
        ...
        var i = Object.keys(n.attributes)
                      .map(function ( e ) {return e + '="' + (n.attributes[ e ] || '').replace(/"/g, '&quot;') + '"';})
                      .join(' ');
        return '<' + n.tag + ' class="' + n.classes.join(' ') + '"' + (i
                                                                       ? ' ' + i
                                                                       : '') + '>' + n.content + '</' + n.tag + '>';
...
Prism.languages.markup = {
  ...
  entity:  /&#?[\da-z]{1,8};/i
}, Prism.languages.markup.tag.inside[ 'attr-value' ].inside.entity = Prism.languages.markup.entity, Prism.hooks.add('wrap', function ( a ) {'entity' === a.type && (a.attributes.title = a.content.replace(/&amp;/, '&'));}), Object.defineProperty(Prism.languages.markup.tag, 'addInlined', {
  value: function ( a, e ) {
    var s = {};
    s[ 'language-' + e ] = {
      pattern:    /(^<!\[CDATA\[)[\s\S]+?(?=\]\]>$)/i,
              ...
              if ('string' == typeof a || a.content && 'string' == typeof a.content) {
                ...
                if (-1 < u) {
                  ...
                  var g = c.substring(0, u),
                      ...
                      f = [];
                  g && f.push.apply(f, e([ g ])), f.push(l), s && f.push.apply(f, e([ s ])), 'string' == typeof a
                                                                                             ? n.splice.apply(n, [
                      t, 1
                    ].concat(f))
                                                                                             : a.content = f;
...
!function ( n ) {
  ...
  }), delete n.languages.php.string, n.hooks.add('before-tokenize', function ( e ) {if (/<\?/.test(e.code)) {n.languages[ 'markup-templating' ].buildPlaceholders(e, 'php', /<\?(?:[^"'/#]|\/(?![*/])|("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|(?:\/\/|#)(?:[^?\n\r]|\?(?!>))*|\/\*[\s\S]*?(?:\*\/|$))*?(?:\?>|$)/gi);}}), n.hooks.add('after-tokenize', function ( e ) {n.languages[ 'markup-templating' ].tokenizePlaceholders(e, 'php');});
}(Prism);
Prism.languages.sql = {
  comment:     {
    pattern:    /(^|[^\\])(?:\/\*[\s\S]*?\*\/|(?:--|\/\/|#).*)/,
  ...
  n.languages.regex = {
    charset:          {
      ...
      inside:     {
        ...
        range:                 {
          pattern: s,
          inside:  { escape: a, 'range-punctuation': /-/ }
        },
        'special-escape':      e,
        charclass:             r,
        backreference:         c,
    ...
    'actionscript', 'coffescript', 'flow', 'javascript', 'typescript', 'vala'
  ].forEach(function ( e ) {
    var a = n.languages[ e ];
    a && (a.regex.inside = {
      'regex-flags':     /[a-z]+$/,
  ...
  if ('undefined' != typeof self && self.Prism && self.document) {
    ...
    var t = Prism.plugins.toolbar.registerButton = function ( t, n ) {
          ...
          e = 'function' == typeof n
              ...
              : function ( t ) {
              var e;
              return 'function' == typeof n.onClick
                     ? ((e = document.createElement('button')).type = 'button', e.addEventListener('click', function () {n.onClick.call(this, t);}))
                     : 'string' == typeof n.url
                       ? (e = document.createElement('a')).href = n.url
                       : e = document.createElement('span'), e.textContent = n.text, e;
            }, r.push(i[ t ] = e);
        },
        e = Prism.plugins.toolbar.hook = function ( a ) {
          ...
          if (t && /pre/i.test(t.nodeName) && !t.parentNode.classList.contains('code-toolbar')) {
            ...
            o.classList.add('toolbar'), document.body.hasAttribute('data-toolbar-order') && (r = document.body.getAttribute('data-toolbar-order')
                                                                                                         .split(',')
                                                                                                         .map(function ( t ) {return i[ t ] || n;})), r.forEach(function ( t ) {
              var e = t(a);
              if (e) {
    ...
    t('label', function ( t ) {
      ...
      if (e && /pre/i.test(e.nodeName) && e.hasAttribute('data-label')) {
        ...
        try {a = document.querySelector('template#' + o);} catch ( t ) {}
        return a
               ? n = a.content
               : (e.hasAttribute('data-url')
                  ? (n = document.createElement('a')).href = e.getAttribute('data-url')
                  : n = document.createElement('span'), n.textContent = o), n;
      }
  ...
  if ('undefined' != typeof self && self.Prism && self.document) if (Prism.plugins.toolbar) {
    ...
    Prism.plugins.toolbar.registerButton('show-language', function ( a ) {
      ...
      if (e && /pre/i.test(e.nodeName)) {
        var s,
            t = e.getAttribute('data-language') || r[ a.language ] || ((s = a.language)
                                                                       ? (s.substring(0, 1)
                                                                           .toUpperCase() + s.substring(1)).replace(/s(?=cript)/, 'S')
                                                                       : s);
        if (t) {
